...
<head>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link"><i class="icon-users2 teal"></i><span class="selected-language">ระบบบุคลากร</span></a>
                <div aria-labelledby="dropdown-flag" class="dropdown-menu"><a href="?page=person_list" class="dropdown-item"><i class="icon-user"></i> ทะเบียนบุคลากร</a></div>
              </li>
              <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link"><i class="icon-cog teal"></i><span class="selected-language">ตั้งค่าข้อมูลพื้นฐาน</span></a>
                <div aria-labelledby="dropdown-flag" class="dropdown-menu">
                <a href="?page=setting_department" class="dropdown-item"><i class="icon-library"></i> ตั้งค่ากลุ่มงาน</a>
                <a href="?page=setting_department_sub" class="dropdown-item"><i class="icon-office"></i> ตั้งค่าฝ่าย/งาน</a>
                <a href="?page=setting_org_leder" class="dropdown-item"><i class="icon-user-tie"></i> ทำเนียบผู้บริหาร</a>
                </div>
              </li>
            </ul>
 ...
 <script src="app-assets/js/core/libraries/jquery.min.js" type="text/javascript"></script>
    ...
    <script src="includes/DataTables/js/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="includes/DataTables/js/dataTables.bootstrap4.min.js" type="text/javascript"></script>

<link rel="stylesheet" href="includes/Buttons/css/buttons.bootstrap4.min.css"> 
<script src="includes/Buttons/js/dataTables.buttons.min.js"></script>
...
<script src="//cdn.datatables.net/buttons/1.4.1/js/buttons.print.min.js"></script>
    ...
    <script src="includes/select2/js/select2.min.js" type="text/javascript"></script>
